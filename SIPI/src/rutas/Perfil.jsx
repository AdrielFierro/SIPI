...
const Perfil = () => {
    ...
    useEffect(() => {
      const fetchFavoritas = async () => {
        try {
          const response = await fetch(`https://sipi-back-7dkp.onrender.com/user/favoritas/${nom_usuario}`);
          if (!response.ok) {
    ...
    useEffect(() => {
      const fetchPendientes = async () => {
        try {
          const response = await fetch(`https://sipi-back-7dkp.onrender.com/user/pendientes/${nom_usuario}`);
          if (!response.ok) {
    ...
    useEffect(() => {
      const obtenerGrupos = async () => {
        try {
          const response = await fetch(`https://sipi-back-7dkp.onrender.com/grupos/${nom_usuario}`);
          const data = await response.json();
          if (response.ok) {
    ...
    const handleCrearGrupo = async () => {
      ...
      if (nombreGrupo) {
        try {
          const response = await fetch(`https://sipi-back-7dkp.onrender.com/grupos/${nom_usuario}/${nombreGrupo}`, {
            method: 'POST',
            headers: {
    ...
    const buscarGrupo = async () => {
      ...
      if (nombreGrupo) {
          try {
            const response = await fetch(`https://sipi-back-7dkp.onrender.com/grupos/unirse/${nom_usuario}/${nombreGrupo}`, {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json',
              }          
