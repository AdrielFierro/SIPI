...
const Usuario = () => {
    ...
    useEffect(() => {
      const fetchUltimaFavorita = async () => {
        try {
          ...
          const response = await fetch(`https://sipi-back-7dkp.onrender.com/user/ultimaFavorita/${nom_usuario}`);
          if (!response.ok) {
    ...
    useEffect(() => {
      const fetchPlataformaId = async () => {
        try {
          const response = await fetch(`https://sipi-back-7dkp.onrender.com/user/plataformas/${nom_usuario}`);
          if (!response.ok) {
